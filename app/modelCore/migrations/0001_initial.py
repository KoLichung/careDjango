# Generated by Django 4.0.5 on 2022-06-29 02:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('speaker', models.CharField(choices=[('0', 'user'), ('1', 'servant')], max_length=1)),
                ('content', models.TextField(blank=True, default='', null=True)),
                ('create_time', models.DateTimeField(auto_now=True, null=True)),
                ('case', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='modelCore.case')),
                ('servant', models.ForeignKey(default='', on_delete=django.db.models.deletion.RESTRICT, to='modelCore.servant')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='case',
            name='servant',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.RESTRICT, related_name='servant', to='modelCore.servant'),
        ),
        migrations.AddField(
            model_name='case',
            name='specify_servant_1',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='specify_servant_1', to='modelCore.servant'),
        ),
        migrations.AddField(
            model_name='case',
            name='specify_servant_2',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='specify_servant_2', to='modelCore.servant'),
        ),
        migrations.AddField(
            model_name='case',
            name='specify_servant_3',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='specify_servant_3', to='modelCore.servant'),
        ),
    ]
